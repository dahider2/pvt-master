...
<!-- Slider -->
  <div class="slider">
    <ul class="rslides" id="slider">
      ...
      <li>
        <div class="w3ls-slide-text">
          <h3>Voir les promotions en cours</h3>
          <a href="categories.html" class="w3layouts-explore">Voir</a>
        </div>
      </li>
      <li>
        <div class="w3ls-slide-text">
      ...
      <div class="container">
        <div class="col-md-3">
          <div class="focus-grid w3layouts-boder1">
            <a class="btn-8" href="categories">
              <div class="focus-border">
                <div class="focus-layout">
                  <div class="focus-image"><i class="fa fa-mobile"></i></div>
                  <h4 class="clrchg">Telephones</h4>
                </div>
              </div>
            </a>
          </div>
          ...
          <a class="btn-8" href="categories.html#parentVerticalTab2">
            <div class="focus-border">
              <div class="focus-layout">
                ...
                <h4 class="clrchg"> Electronics & Electromenageres</h4>
              </div>
            </div>
          </a>
        </div>
          ...
          <a class="btn-8" href="categories.html#parentVerticalTab6">
            <div class="focus-border">
              <div class="focus-layout">
                ...
                <h4 class="clrchg">Animal domestique</h4>
              </div>
            </div>
          </a>
        </div>

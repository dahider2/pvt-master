<header>
  <div class="w3ls-header"><!--header-one-->
    <div class="w3ls-header-left">
      <p><a href="#"><i class="fa fa-download" aria-hidden="true"></i>P V T  </a></p>
    </div>
...
<!-- Large modal -->
  ...
  <div class="container">
    <div class="agile-its-header">
      <div class="logo">
        <h1><a href="{{ Url('wel') }}"><span>Re</span>sale-v2</a></h1>
      </div>
      ...
      <a class="post-w3layouts-ad" href="{{ Route('postad')}}">Post Free Ad</a>
      </div>
      <div class="clearfix"></div>
    </div>
  </div>
